...
const games = [
  ...
  { id: 2, name: "SOS", image: sosImg, url: "/games/sos", isHot: true, isInternal: true, category: "cards" },
  { id: 3, name: "Lottery", image: lotteryImg, url: "/games/lottery", isHot: true, isInternal: true, category: "lottery" },
  { id: 4, name: "High or Low", image: highOrLowImg, url: "/games/high-or-low", isHot: true, isInternal: true, category: "cards" },
  ...
  { id: 9, name: "Jackpot", image: jackpotImg, url: "/games/jackpot", isHot: true, isInternal: true, category: "slot" },
  { id: 10, name: "F1 Formula", image: f1FormulaImg, url: "/games/f1-formula", isHot: true, isInternal: true, category: "sports" },
  { id: 11, name: "PLINKO", image: plinkoImg, url: "/games/plinko", isHot: true, isInternal: true, category: "lottery" },
  { id: 12, name: "Wingo", image: wingoImg, url: "/games/wingo", isHot: true, isInternal: true, category: "lottery" },
  ...
  { id: 15, name: "Dice", image: diceImg, url: "/games/dice", isHot: true, isInternal: true, category: "lottery" },
  ...
  { id: 18, name: "Keno", image: kenoImg, url: "/games/keno", isHot: true, isInternal: true, category: "lottery" },
  { id: 19, name: "Crash", image: crashImg, url: "/games/crash", isHot: true, isInternal: true, category: "live" },
  { id: 20, name: "Chicken Road", image: chickenRoadImg, url: "/games/chicken-road", isHot: true, isInternal: true, category: "lottery" },
];
